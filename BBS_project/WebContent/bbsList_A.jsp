...
<body>
  ...
  <div class="container">
    ...
    System.out.print(T_img_name);
  
    	%>
   
    	<div class="col-md-4 mb-5">
      <div class="card h-100">
        <img class="card-img-top" src="storage/summer.jpg" width="300" height="200" alt="">
        <div class="card-body">
          <h4 class="card-title"><a href="bbsDetail.jsp?Tname=<%=Tname%>"><%=T_img_name%></a></h4>
          <p class="card-text"><%=Tcontent%></p>
        </div>
